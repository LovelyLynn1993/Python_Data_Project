...
View my notebook with detailed steps here: [1_Skill_Demand.ipynb](WIP\1_Skill_Demand.ipynb)
...
sns.barplot(data=df_plot, x='skill_percent', y= 'job_skills', ax=ax[1], hue='skill_count', palette='blend:g,b')
...
### Results
![Likelihood of Skills Requesting in the US Job Postings'](Images\SkillsTrending.png)
...
View my notebook with detailed steps here: [2_Skill_Trend.ipynb](WIP\2_Skills_Trend.ipynb)
...
View my notebook with detailed steps here: [3_Salary_Analysis](WIP\3_Salary_Analysis.ipynb)
...
View my notebook with detailed steps here: [4_Optimal_Skills](WIP\4_Optimal_Skills.ipynb)
